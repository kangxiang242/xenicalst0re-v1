                        ...
                        <div class="card">
                            ...
                            <div class="main">
                                <div class="form-wrap">
                                    ...
                                    <div class="form-radio">
                                        <input class="hide" type="radio" id="pack-2" name="pack_type">
                                        <label for="pack-2" class="radio-label grow">
                                            <span class="dress"></span>
                                            <div class="article">
                                                <p class="text"><span class="s1">普通包裝：</span><span class="s2">無特殊包裝&資訊顯示</span></p>
                                                <p class="price">+NT$ 0</p>
                                            </div>
                                        </label>
                                    </div>
                    ...
                    <div class="right-side">
                        ...
                        <div class="card">
                            ...
                            <div class="main">
                                <div class="amount">
                                    <div class="goods">
                                        <p class="name">{{ app('cache.config')->get('page_product_title') }}<br>{{ $spec }}mg/{{ $goods->quantity }}盒（{{ $goods->quantity*4 }}錠）</p>
                        ...
                        <div class="btn-main">
                            <div class="law">
                                <div class="group">
                                    ...
                                    <label for="clause1">我同意遵守禮來《個人購買說明》條款</label>
                                </div>
                                <div class="group">
                                    <input type="checkbox" name="clause2" value="1" id="clause2" checked>
                                    <label for="clause2">我同意接受禮來《服務條款》及《客戶隱私保護》條款</label>
                                </div>
                                <div class="group">
                                    <input type="checkbox" name="clause3" value="1" id="clause3" checked>
                                    <label for="clause3">為保障彼此之權益，禮來收到您的訂單後仍保有決定是否接受訂單及出貨與否之權利</label>
                                </div>
                            </div>
                            <button class="btn form-btn">安全送出</button>
                        </div>
                    </div>
                </div>
            </form>
